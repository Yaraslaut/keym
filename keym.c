...
int main()
{
    ...
    while (1)
    {
        ...
        /* mouse clicks */
        XTestFakeButtonEvent(display, Button1, pressed(XK_q) ? True : False, CurrentTime);
        XTestFakeButtonEvent(display, Button3, pressed(XK_e) ? True : False, CurrentTime);
        XTestFakeButtonEvent(display, Button2, pressed(XK_c) ? True : False, CurrentTime);
